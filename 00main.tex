...
\vfill
\centerline{\Large\sf Questa tesi è stata sviluppata in  \raisebox{-0.05truecm}{\epsfig{file=Figure/logo_small.jpg,width=2truecm}}}
...
\input{Capitoli/Introduzione/0introduzione.tex}
\input{Capitoli/Introduzione/1cloud-computing.tex}
\input{Capitoli/Introduzione/2multi-cloud.tex}
\input{Capitoli/Introduzione/3containerizzazione.tex}
\input{Capitoli/Introduzione/4kubernetes.tex}


% %%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \chapter{Stato dell'Arte}
% \input{2statoarte.tex}
